...
dependencies {
  ...
  // that requires dependency version to be resolved by platform("mikufan.cx.yc:dev-version-constraints").
  ...
  api(platform("mikufan.cx.yc:plugin-version-constraints"))

  // another way 1 is to includeBuild() yet another plugin build inside this plugin build's settings.gradle.kts,
  // and group `kotlin-dsl` and 'platform("mikufan.cx.yc:dev-version-constraints")' into another plugin
